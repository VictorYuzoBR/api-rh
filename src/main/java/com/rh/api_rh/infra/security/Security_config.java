    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/candidato/perfil/**").hasAnyRole("ADMIN", "RH")
                        .requestMatchers(HttpMethod.GET, "/candidato/meuperfil").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/espelho/meuespelho").hasAnyRole("ADMIN", "RH","FUNCIONARIO")
                        ...
                        .requestMatchers(HttpMethod.GET, "/espelho/**").hasAnyRole("ADMIN", "RH")
                        ...
                        .requestMatchers(HttpMethod.GET, "/funcionario/meuperfil").hasAnyRole("ADMIN", "RH","FUNCIONARIO")
                        .requestMatchers(HttpMethod.GET, "/funcinario/**").hasAnyRole("ADMIN", "RH")
